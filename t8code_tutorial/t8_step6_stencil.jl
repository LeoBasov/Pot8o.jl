...
function t8_step6_create_element_data(forest)
    ...
    element_data = Array{t8_step6_data_per_element_t}(undef,
                                                      num_local_elements +
                                                      num_ghost_elements)
    ...
    for itree in 0:(num_local_trees - 1)
        ...
        for ielement in 0:(num_elements_in_tree - 1)
            ...
            element_data[current_index] = t8_step6_data_per_element_t(level, volume,
                                                                      Tuple(midpoint), dx,
                                                                      dy, height, 0.0, 0.0)
        end
    end
...
function t8_step6_compute_stencil(forest, element_data)
    ...
    for itree in 0:(num_local_trees - 1)
        ...
        for ielement in 0:(num_elements_in_tree - 1)
            ...
            element_data[current_index] = t8_step6_data_per_element_t(element_data[current_index].level,
...
function t8_step6_exchange_ghost_data(forest, element_data)
    ...
    sc_array_wrapper = sc_array_new_data(pointer(element_data),
                                         sizeof(t8_step6_data_per_element_t),
                                         length(element_data))
